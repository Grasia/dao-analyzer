...
class StVoteOutcomeTest(unittest.TestCase):
    ...
    def test_process_data(self):
        ...
        in_df: pd.DataFrame = pd.DataFrame([
            ...
            {'yea': 1, 'nay': 0, 'supportRequiredPct': 100000000000000000, 'minAcceptQuorum': 33, 'votingPower': 3,'startDate': bl.unix()},#today_year-(today_month-2)-05T00:00:00+00:00
            {'yea': 5, 'nay': 4, 'supportRequiredPct': 33, 'minAcceptQuorum': 15, 'votingPower': 9,'startDate': bl.add(month=2).change(day=1, hour=23, minute=59, second=59).unix()},#today_year-today_month-01T23:59:59+00:00
            {'yea': 0, 'nay': 0, 'supportRequiredPct': 0, 'minAcceptQuorum': 0, 'votingPower': 00000000000000000,'startDate': bl.unix()},#today_year-today_month-01T23:59:59+00:00
