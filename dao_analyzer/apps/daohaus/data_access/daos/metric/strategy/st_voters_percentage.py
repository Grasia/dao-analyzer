...
import dao_analyzer.apps.daohaus.data_access.daos.metric.strategy.st_total_members \
    as m_members
import dao_analyzer.apps.daohaus.data_access.daos.metric.strategy.st_active_voters \
    as m_voters
