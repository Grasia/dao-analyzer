...
import dao_analyzer.apps.daostack.data_access.daos.metric.strategy.\
...
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_active_users\
    import StActiveUsers
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_active_organization\
    import StActiveOrganization
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_approval_proposal_rate\
    import StApprovalProposalRate
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_assets_tokens import StAssetsTokens
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_assets_values import StAssetsValues
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_votes_voters_rate\
    import StVoteVotersRate
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_votes_rate\
    import StVotesRate
from dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_total_reputation_holders\
