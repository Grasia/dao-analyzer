...
import dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_total_reputation_holders \
    as reputation_holders
import dao_analyzer.apps.daostack.data_access.daos.metric.strategy.st_different_voters_stakers \
    as m_voters
