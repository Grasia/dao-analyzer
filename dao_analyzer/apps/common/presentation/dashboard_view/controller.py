...
from dao_analyzer.apps.common.presentation.dashboard_view.dashboard_view import _get_dao_info
...
def bind_callbacks(app, section_id: str, organizationsDAO: OrganizationListDao) -> None:
    ...
    def organization_section_name(value: str, options: dict) -> html.Div:
        ...
        return _get_dao_info(name, result.get_network(), result.get_id(), result.get_creation_date())
